...
3. Copy and rename the `.example.npmrc` as `.npmrc` in the project root and replace the authToken with your Font Awesome pro token.
4. Run `yarn install` from project root to install packages and dependencies.
